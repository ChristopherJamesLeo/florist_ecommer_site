    ...
    <section class="page-header mb-5">
        <div class="py-5 page-header-container">
            <div class="text-center mx-auto page-header-content">
                <h1>Register</h1>
                <span class="text-uppercase text-muted"><a href="./index.php">home</a> &nbsp; | &nbsp; <a href="./register.php" class="text-muted">Register</a></span>
            </div>
        </div>
    </section>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control rounded-0 py-2 px-3">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="password" class="mb-2">Password</label>
                                    <input type="password" name="password" id="password" class="form-control rounded-0 py-2 px-3">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="password" class="mb-2">Role</label>
                                    
                                    <select name="role" id="role"  class="form-select-input rounded-0 ms-5 py-2 px-5">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="phonenumber" id="phonenumber" class="form-control rounded-0 py-2 px-3">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="city" class="mb-2">City</label>
                                    <input type="text" name="city" id="city" class="form-control rounded-0 py-2 px-3">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="address" class="mb-2">Address</label>
                                    <input type="text" name="str-address" id="str-address" class="form-control rounded-0 py-2 px-3 mb-3" placeholder="Steet Address">
                                ...
                                <div class="form-group mb-4">
                                    <label for="country" class="mb-2">Country/State</label>
                                    <input type="text" name="country" id="country" class="form-control rounded-0 py-2 px-3">
                                </div>
                                <div class="form-group mb-4">
                            ...
                            <div class="form-group">
                                <div class="d-grid">
                                    <input type="submit" value="Register" class="text-uppercase btn rounded-0 fw-bold">
                                </div>
