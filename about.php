...
<body>
    ...
    <section class="page-header mb-5">
        <div class="py-5 page-header-container">
            <div class="text-center mx-auto page-header-content">
                <h1>About Us</h1>
                <span class="text-uppercase text-muted"><a href="./index.php">home</a> &nbsp; | &nbsp; <a href="./about.php" class="text-muted">about</a></span>
            </div>
        </div>
    </section>
    ...
    <section class="our-benefits py-5">
        <div class="our-benefits-container about-us-service-container container pt-5">
            <div class="d-flex justify-content-between align-items-center py-5 latest-post-heard-container ">
                <div class="mx-auto text-center latest-post-header about-us-service-header">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                    <div class="d-flex flex-column justify-content-start align-items-start  border about-us-service-contents-box">
                        <div class="benefits-icons about-us-benefit-icons mx-auto">
                            <img src="./assets/imgs/logo_fav/services-1.png.webp" alt="services-1.png">
                        </div>
                        <div class="text-center benefits">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                    <div class="d-flex flex-column justify-content-start align-items-start  border about-us-service-contents-box">
                        <div class="benefits-icons about-us-benefit-icons mx-auto">
                            <img src="./assets/imgs/logo_fav/services-2.png.webp" alt="services-1.png">
                        </div>
                        <div class="text-center benefits">
                            <h2 class="mb-2">Event decoration</h2>
                            <p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                    <div class="d-flex flex-column justify-content-start align-items-start  border about-us-service-contents-box">
                        <div class="benefits-icons about-us-benefit-icons mx-auto">
                            <img src="./assets/imgs/logo_fav/services-3.png.webp" alt="services-1.png">
                        </div>
                        <div class="text-center benefits">
                            <h2 class="mb-2">Green landscape</h2>
                            <p>
                                Flower helps you perfectly express how important your significant.
                            </p>
                        </div>
        ...
        <div class="container latest-post-container">
            <div class="d-flex justify-content-between align-items-center py-5 latest-post-heard-container ">
                <div class="latest-post-header">
                    <h4 class="text-uppercase">OUR TEAM MEMBER</h4>
                    <h1>Flower Experts</h1>
                </div>
                <div class="latest-post-btn-container">
                    <a href="#" class="btn text-uppercase">MEET OUR TEAM</a>
                </div>
            </div>
            <div class="latest-post-body-container">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-12 p-3 latest-body-items-container about-us-team-container">
                        <div class="lates-body-items-img-container">
                            <img src="./assets/imgs/avators/team-1.jpg.webp" alt="blog 1">
                        </div>
                        <div class="text-center mt-3 p-3 our-team-body-items-content-container ">
                            <h1>Richard Osborne</h1>
                            <p class="">
                                Manager
                            </p>
                            <div class="text-center our-team-content-link-icons">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 p-3 latest-body-items-container about-us-team-container">
                        <div class="lates-body-items-img-container">
                            <img src="./assets/imgs/avators/team-2.jpg.webp" alt="blog 1">
                        </div>
                        <div class="text-center mt-3 p-3 our-team-body-items-content-container ">
                            <h1>Richard Osborne</h1>
                            <p class="">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 p-3 latest-body-items-container about-us-team-container">
                        <div class="lates-body-items-img-container">
                            <img src="./assets/imgs/avators/team-3.jpg.webp" alt="blog 1">
                        </div>
                        <div class="text-center mt-3 p-3 our-team-body-items-content-container ">
                            <h1>Richard Osborne</h1>
                            <p class="">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 p-3 latest-body-items-container about-us-team-container">
                        <div class="lates-body-items-img-container">
                            <img src="./assets/imgs/avators/team-4.jpg.webp" alt="blog 1">
                        </div>
                        <div class="text-center mt-3 p-3 our-team-body-items-content-container ">
                            <h1>Richard Osborne</h1>
                            <p class="">
    ...
    <!-- custom js -->
    <!-- <script src="./custom_js/about.js"></script> -->
<script>
